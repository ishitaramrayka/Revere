...
function CalendarLume({ selectedDate: controlledDate, onSelectDate }: CalendarLumeProps) {
  ...
  return (
    <div className="rounded-xl bg-background/80 backdrop-blur-md w-[380px] p-4 text-foreground">
      {/* Header */}
            ...
            {eachMonthOfInterval({
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  setStep("day");
                  updateSelectedDate(new Date(selectedYear, month.getMonth(), 1));
                }}
              >
