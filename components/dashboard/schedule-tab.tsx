...
import { Plus, GripVertical, Pill, Utensils, Dumbbell, Calendar, ChevronDown } from 'lucide-react'
    ...
    <div className="max-w-2xl">
      ...
      <div className="flex items-start justify-between mb-8 animate-fade-up" style={{ animationDelay: '0ms' }}>
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
            {schedule.length} reminders configured for today.
          </p>
        </div>
        <button
      ...
      <div
        className={cn(
          ...
          showAddForm ? 'max-h-60 mb-5 opacity-100' : 'max-h-0 opacity-0'
        )}
      >
        <div className="bg-card rounded-2xl border border-border shadow-[0_2px_12px_-4px_rgba(0,0,0,0.06)] p-5">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:opacity-90 active:scale-[0.97] transition-all duration-200 shrink-0"
            >
              Save
            </button>
          </div>
            ...
            {filtered.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={cn(
                      'flex-1 flex items-center justify-between px-4 py-3 rounded-xl border bg-card',
